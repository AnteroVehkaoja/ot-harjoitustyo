...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortin_lisaaminen_negatiivinen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-1000)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_kortti_voi_ostaa_edullisen_lounaan_kun_vain_250_rahaa(self):
        kortti = Maksukortti(250)

        kortti.syo_edullisesti() 

        self.assertEqual(kortti.saldo_euroina(), 0.0)
    def test_kortti_voi_ostaa_maukkaan_lounaan_kun_vain_250_rahaa(self):
